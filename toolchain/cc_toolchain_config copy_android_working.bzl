...
def _impl(ctx):
                    ...
                    flag_groups = ([
                        flag_group(
                            flags = [
                                "-stdlib=libc++",
                                "-fuse-ld=lld",
                                "-L/externaldisk/data/dev/sdk/aosp/android-10.0.0/lib64",
                                "-lc++",
                                "-lm",
                                "-fPIC",
                                "-frtti",
                                ...
                                "--sysroot=/externaldisk/data/dev/sdk/aosp/android-10.0.0/sysroot64/",
                                "-mcpu=generic",
                                "-v",
                                "-llog",
                            ],
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        builtin_sysroot = "/externaldisk/data/dev/sdk/aosp/android-10.0.0/sysroot64/",
        cxx_builtin_include_directories = [
            "/externaldisk/data/dev/sdk/llvm-8.0/host/x86_64/Release/lib/clang/8.0.1/include/c++/v1",
            "/externaldisk/data/dev/sdk/aosp/android-10.0.0/sysroot64/usr/include/aarch64-linux-android",
            "/externaldisk/data/dev/sdk/aosp/android-10.0.0/sysroot64/usr/include",
            "/externaldisk/data/dev/sdk/llvm-8.0/host/x86_64/Release/lib/clang/8.0.1/include/"
        ],
        toolchain_identifier = "local",
        host_system_name = "local",
        target_system_name = "arm64_v8a",
