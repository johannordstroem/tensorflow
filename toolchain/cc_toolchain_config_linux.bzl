                    ...
                    flag_groups = ([
                        flag_group(
                            flags = [
                                "-stdlib=libc++",
                                "-fuse-ld=lld",
                                "-L/externaldisk/data/dev/sdk/llvm-8.0/host/x86_64/Release/lib/clang/8.0.1/x86_64-unknown-linux-gnu/lib",
                                "-Wl,-rpath,/externaldisk/data/dev/sdk/llvm-8.0/host/x86_64/Release/lib/clang/8.0.1/x86_64-unknown-linux-gnu/lib",
                                "-lc++",
                                "-lm",
                                "-fPIC",
                                "-lrt",
